...
import {  createPost,
  ...
  getAllPosts,
  incrementPostLike,
  postComment} from '@/config/redux/action/postAction';
...
useEffect(() =>{
    if(authState.connections && authState.connections.some(user => user.connectionId._id === userProfile.userId._id)){
    ...
    return ( 
        ...
        <div className={style.container}>
         <div className={style.backDropContainer}>
            <img className={style.backDrop} src={`${BASE_URL}/${userProfile.userId.profilePicture}`} alt="backDrop"></img>
            </div> 
            <div className={style.profileContainer_details}>

            <div style={{display:"flex" , gap:"0.7rem"}}>
                <div style={{flex:"0.8"}}>
                  <div style={{display:"flex" , width:"fit-content", alignItems:"center" , gap:"0.8rem"}}>
                ...
                <button className={style.connectionButton}>{isConnectionNull ? "Pending" : "connected"}</button>
                :
                ...
                style={{width:"1.2rem" , cursor:"pointer" ,marginTop:"12px" }}>
        ...
        <div className={style.workHistory}>
            ...
            <div className={style.workHistoryContainer}>
                 {userProfile.pastwork.length === 0 && <p style={{color:"grey"}} >Not Added</p>}
             {
                userProfile.pastwork.map((work,index) =>{
                    return (
                        ...
                        <p>+{work.years} years Experience</p>
                        </div>
                    )
                })
             }   
        ...
        <div className={style.workHistory}>
            <h4>Education</h4>
            <div className={style.workHistoryContainer}>
             {userProfile.education.length === 0 && <p style={{color:"grey"}} >Not Added</p>}
             {
             ...
             {userPosts.map((post) =>{
                return (
                    ...
                    <div className={style.card}>
                        ...
                        <div style={{display:"flex", gap:"1rem"}}  onClick={async()=>{
